...
namespace MCTStickers.Interfaces {
  ...
  public interface IStickerSetIndexer {
    ...
    Task IndexStickerSetAsync(StickerSet stickerSet, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<Sticker>> FindStickersByQuery(string query, int skip = 0, int count = 25, CancellationToken cancellationToken = default);
  }
}
