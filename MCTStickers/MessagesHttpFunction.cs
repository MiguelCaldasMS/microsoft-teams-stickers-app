...
namespace MCTStickers {
  ...
  using MCTStickers.Config;
  using MCTStickers.Extensions;
  using MCTStickers.Interfaces;
  using MCTStickers.Providers;
  ...
  public class MessagesHttpFunction {
    ...
    public MessagesHttpFunction(TelemetryConfiguration telemetryConfiguration, ISettings settings = null, IStickerSetRepository stickerSetRepository = null, IStickerSetIndexer stickerSetIndexer = null, ICredentialProvider credentialProvider = null, IChannelProvider channelProvider = null) {
