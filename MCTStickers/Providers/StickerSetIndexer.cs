...
namespace MCTStickers.Providers {
  using System;
  ...
  public class StickerSetIndexer: IStickerSetIndexer {
    ...
    /// <inheritdoc />
    public Task IndexStickerSetAsync(StickerSet stickerSet, CancellationToken cancellationToken = default) {
    ...
    /// <inheritdoc />
    public Task<IEnumerable<Sticker>> FindStickersByQuery(string query, int skip = 0, int count = 25, CancellationToken cancellationToken = default) {
